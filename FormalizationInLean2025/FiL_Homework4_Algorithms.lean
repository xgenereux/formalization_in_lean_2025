...
The exercices numbers refer to the ones from the book.
-/
...
#eval (range' 1 5).reverse
#eval time_insort (range' 1 20)
#eval time_insort (range' 1 20).reverse
